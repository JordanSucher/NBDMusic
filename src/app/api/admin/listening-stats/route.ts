  ...
  try {
    ...
    const artists = Object.values(artistGroups)
      .map((group: any) => {
        ...
        const listenerCounts = group.listens.reduce((acc: Record<string, any>, listen: any) => {
